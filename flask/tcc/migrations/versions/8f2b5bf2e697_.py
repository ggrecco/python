...
Revision ID: 8f2b5bf2e697
Revises: 
Create Date: 2018-04-26 22:07:24.222790
...
def upgrade():
    ...
    op.create_index(op.f('ix_resultado_datas'), 'resultado', ['datas'], unique=False)
    op.create_table('dados',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_resultado', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['id_resultado'], ['resultado.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('dados')
    op.drop_index(op.f('ix_resultado_datas'), table_name='resultado')
